...
public class level {
	...
	public level(int[][] map, Image wallImage, int scale, ObservableList<Node> root, ImageView[] walls, ImageView gate, ImageView portal, ImageView blueKey, ImageView blueKeyWall, Image blueKeyImage, Image blueKeyWallImage, Image gateImage)
	{
		this.map = map;
